...
[Click here for an interactive biplot of dimension 1 & 2 with responses for this topic.](/images/feel/feel_plotly12.html)

<img src="/images/feel/feel_biplot12.png" title="Biplot for Dimensions 1 and 2 for 'Emotional Impact'" width="600">ABOVE: Biplot for Dimensions 1 and 2 for 'Emotional Impact'</img>
...
|:---------------|:--------|:-----------------|:-------------------------|:-------------|:-------------|
| feel          | PC2    | hs_arts_freq    | Occasionally-Never      | 1.026224411 | 0.026920793 |
| feel          | PC2    | hs_arts_freq    | Frequently-Never        | 1.107645441 | 0.013969469 |
| feel          | PC2    | sr_participated | Yes-No                  | 0.958092239 | 2.11E-05    |
| feel          | PC2    | artsincollege   | Yes-No                  | 0.592921711 | 9.14E-05    |


### Figure 1.1 High School Arts Participation and Dimension 2

<img src="/images/feel/demos/PC2-hs_arts_freq.png" title="Density plot of hs_arts_freq contrasts" width="800">ABOVE: Density plot of `hs_arts_freq contrasts`. Demographic variables that showed contrasts (Tukey adj.p.value < 0.05) between factor levels indicated differences that are unlikely to be due to chance. These differences may suggest an association between the direction of the demographic factors difference and the emotional impact described by the accompanying dimension/principal component.</img>

### Figure 1.2 Participated in College and Dimension 2

<img src="/images/feel/demos/PC2-sr_participated.png" title="Density plot of sr_participated contrasts" width="800">ABOVE: Density plot of `sr_participated` contrasts. Demographic variables that showed contrasts (Tukey adj.p.value < 0.05) between factor levels indicated differences that are unlikely to be due to chance. These differences may suggest an association between the direction of the demographic factors difference and the emotional impact described by the accompanying dimension/principal component.</img>

### Figure 1.2 Arts in College and Dimension 2

<img src="/images/feel/demos/PC2-artsincollege.png" title="Density plot of artsincollege contrasts" width="800">ABOVE: Density plot of `artsincollege` contrasts. Demographic variables that showed contrasts (Tukey adj.p.value < 0.05) between factor levels indicated differences that are unlikely to be due to chance. These differences may suggest an association between the direction of the demographic factors difference and the emotional impact described by the accompanying dimension/principal component.</img>
...
| question_name | PC_num | demographic   | comparison     | estimate    | adj.p.value |
|:---------------|:--------|:---------------|:----------------|:-------------|:-------------|
| feel          | PC3    | hslocation    | Rural-Suburban | 0.388898371 | 0.037443181 |
| feel          | PC3    | so_childhood5 | No-Yes         | 0.409122456 | 0.037470502 |

### Figure 2.1 High School Location and Dimension 3

<img src="/images/feel/demos/PC3-hslocation.png" title="Density plot of hslocation contrasts" width="800">ABOVE: Density plot of `hslocation` contrasts. Demographic variables that showed contrasts (Tukey adj.p.value < 0.05) between factor levels indicated differences that are unlikely to be due to chance. These differences may suggest an association between the direction of the demographic factors difference and the emotional impact described by the accompanying dimension/principal component.</img>

### Figure 2.2 Parental Influence and Dimension 3

<img src="/images/feel/demos/PC3-so_childhood5.png" title="Density plot of so_childhood5 contrasts" width="800">ABOVE: Density plot of `so_childhood5` contrasts. Demographic variables that showed contrasts (Tukey adj.p.value < 0.05) between factor levels indicated differences that are unlikely to be due to chance. These differences may suggest an association between the direction of the demographic factors difference and the emotional impact described by the accompanying dimension/principal component.</img>

<img src="/images/feel/feel_biplot34.png" title="Biplot for Dimensions 3 and 4 for 'Emotional Impact'" width="600">ABOVE: Biplot for Dimensions 3 and 4 for 'Emotional Impact'</img>

[Click here for an interactive biplot of dimension 3 & 4 with responses for this topic.](/images/feel/feel_plotly34.html)
...
| question_name | PC_num | demographic  | comparison              | estimate    | adj.p.value |
|:---------------|:--------|:--------------|:-------------------------|:-------------|:-------------|
| feel          | PC4    | hs_arts_freq | Frequently-Occasionally | 0.284726497 | 0.042470658 |


### Figure 3.1 High School Arts Participation and Dimension 4

<img src="/images/feel/demos/PC4-hs_arts_freq.png" title="Density plot of hs_arts_freq contrasts" width="800">ABOVE: Density plot of `hs_arts_freq` contrasts. Demographic variables that showed contrasts (Tukey adj.p.value < 0.05) between factor levels indicated differences that are unlikely to be due to chance. These differences may suggest an association between the direction of the demographic factors difference and the emotional impact described by the accompanying dimension/principal component.</img>
...
| question_name | PC_num | demographic  | comparison              | estimate     | adj.p.value |
|:---------------|:--------|:--------------|:-------------------------|:--------------|:-------------|
| feel          | PC5    | hs_arts_freq | Frequently-Occasionally | 0.284058036  | 0.02253555  |


### Figure 4.1 High School Arts Participation and Dimension 5

<img src="/images/feel/demos/PC5-hs_arts_freq.png" title="Density plot of hs_arts_freq contrasts" width="800">ABOVE: Density plot of `hs_arts_freq` contrasts. Demographic variables that showed contrasts (Tukey adj.p.value < 0.05) between factor levels indicated differences that are unlikely to be due to chance. These differences may suggest an association between the direction of the demographic factors difference and the emotional impact described by the accompanying dimension/principal component.</img>
...
<img src="/images/feel/feel_screeplot.png" title="Emotional Impacts Scree Plot" width="600"></img>
...
| Emotional Impacts PC | eigenvalue | variance.percent | cumulative.variance.percent |
|:-------|:------------|:------------------|:-----------------------------|
| Dim.1 | 4.44E+00   | 1.85E+01         | 18.52032                    |
| Dim.2 | 3.47E+00   | 1.44E+01         | 32.95865                    |
| Dim.3 | 2.03E+00   | 8.45E+00         | 41.40979                    |
| Dim.4 | 1.90E+00   | 7.93E+00         | 49.33894                    |
| Dim.5 | 1.54E+00   | 6.43E+00         | 55.77083                    |
| Dim.6 | 1.27E+00   | 5.27E+00         | 61.04221                    |
| Dim.7 | 1.20E+00   | 4.99E+00         | 66.0303                     |
| Dim.8 | 1.04E+00   | 4.34E+00         | 70.37352                    |
...
| Emotional Impact Variables | PC1     | PC2     | PC3     | PC4     | PC5       |
|:---------------------------------------------|:---------|:---------|:---------|:---------|:-----------|
| LIWC..function                              | 0.394   | -0.0332 | -0.0484 | -0.1386 | 0.0589    |
| LIWC..Authentic                             | 0.3359  | -0.0258 | -0.0327 | -0.139  | 0.1202    |
| AIC..IC                                     | 0.2165  | -0.2688 | -0.1146 | 0.4968  | -0.0266   |
| AIC..ELAB                                   | 0.183   | -0.2061 | -0.0436 | 0.4818  | -0.0274   |
| AIC..DIAL                                   | 0.181   | -0.2331 | -0.1594 | 0.3838  | -0.0351   |
| topic..Wishful                              | 0.1457  | 0.4269  | -0.0069 | 0.1587  | 0.0081    |
| topic..Regretful                            | 0.1243  | 0.4488  | -0.0102 | 0.1746  | 0.02      |
| topic..Part_of_Something_Bigger             | 0.1124  | -0.2508 | 0.2182  | -0.0185 | -0.0445   |
| topic..Grateful                             | 0.1014  | 0.0529  | 0.4061  | 0.0955  | 0.1871    |
| topic..Well_Rounded                         | 0.0409  | -0.1207 | 0.3749  | -0.0162 | -1.00E-04 |
| topic..Refreshed                            | 0.0117  | -0.0384 | 0.0808  | -0.1813 | -0.4752   |
| topic..Culturally_Aware                     | 0.0105  | -0.0827 | 0.1692  | -0.0996 | -0.4358   |
| topic..Gained_Perspective_and_Appreciation  | -0.0285 | -0.2459 | 0.2624  | -0.1066 | 0.4399    |
| topic..Happy                                | -0.0483 | 0.0545  | 0.222   | 0.1834  | -0.0109   |
| topic..Entertained                          | -0.0594 | 0.3604  | -0.2206 | 0.1389  | 0.0989    |
| topic..Connected_to_Others_through_the_Arts | -0.0785 | -0.218  | -0.0458 | 0.0034  | 0.0019    |
| topic..Less_Stressed_and_More_Expressive    | -0.0853 | -0.1202 | -0.4564 | -0.0746 | -0.1781   |
| topic..Proud                                | -0.1183 | -0.261  | -0.2304 | -0.1951 | 0.1471    |
| topic..Accomplished_and_Creative            | -0.1401 | -0.1045 | -0.3247 | -0.0734 | 0.3723    |
| LIWC..Tone                                  | -0.1998 | -0.0825 | 0.1232  | 0.121   | 0.157     |
| LIWC..Analytic                              | -0.2596 | -0.0983 | -0.0145 | 0.1365  | -0.2357   |
| LIWC..Clout                                 | -0.2762 | -0.0401 | 0.0546  | 0.1342  | -0.1934   |
| LIWC..posemo                                | -0.3985 | 0.048   | 0.1015  | 0.1821  | 0.0877    |
| LIWC..affect                                | -0.4013 | 0.0472  | 0.0588  | 0.1712  | 0.0744    |
